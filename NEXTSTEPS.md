...
# Next Steps for ndx-turner-metadata Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-turner-metadata directory: `cd ndx-turner-metadata`
...
`spec/ndx-turner-metadata.namespace.yaml` and
`spec/ndx-turner-metadata.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-turner-metadata
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/szonjaweigl/ndx-turner-metadata/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-turner-metadata/0.1.0
...
`staged-extensions/ndx-turner-metadata`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-turner-metadata
    ```

13. Edit `staged-extensions/ndx-turner-metadata/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      version: 0.1.0
      src: https://github.com/szonjaweigl/ndx-turner-metadata
      pip: https://pypi.org/project/ndx-turner-metadata/
      license: MIT
      maintainers: 
        - szonjaweigl
      ```

14. Edit `staged-extensions/ndx-turner-metadata/README.md`
to add information about your extension. You may copy it from
`ndx-turner-metadata/README.md`.

  ```bash
  cp ndx-turner-metadata/README.md staged-extensions/ndx-turner-metadata/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-turner-metadata
git commit -m "Add new catalog entry for ndx-turner-metadata" .
git push
```
...
ndx-turner-metadata-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-turner-metadata GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-turner-metadata-record repository on GitHub.
